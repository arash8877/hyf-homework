function getFullName(
  ...
  if (useFormalName) {
    male
      ? (finalName = `Lord ${firstname} ${surname}`)
      : (finalName = `Mis ${firstname} ${surname}`);
  } else {
...
function getEventWeekday(dayNumber) {
  ...
  if (eventIndex === 0) {
    ...
    console.log(`The day of the event is: ${weekDays[eventIndex]}`);
  }
}
getEventWeekday(1);
...
function clothesToWear(temperature) {
  let Clothes;
  if (temperature <= 0) {
    Clothes = "You should wear a puffy jacket";
  } else if (temperature <= 10) {
    Clothes = "You should wear a parka jacket";
  } else if (temperature <= 20) {
    Clothes = "You should wear a windbreaker jacket";
  } else if (temperature > 20 && temperature <= 30) {
    Clothes = "You should wear a shirt";
  } else {
    Clothes = "You should wear a T-shirt";
  }
  return console.log(Clothes);
}
...
function addStudentToClass(studentName) {
  ...
  if (class07Students.length < 7 || studentName === "Queen") {
    if (class07Students.includes(studentName)) {
      ...
      output = class07Students;
    }
  } else {
    output = "Cannot add more students to class 07";
  }
...
function getNumberOfStudents() {
  ...
  return console.log(`There are ${numberOfStudents} student in the class`);
}
